...
<?php include('session.php'); ?>
    <body>
		<?php include('navbar.php'); ?>
		        <center><img src="images/pcu.jpg"></center>
                ...
                <div class="span6" id="">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<?php 
							$query = mysqli_query($connection,"select * from class")or die(mysqli_error());
							$count = mysqli_num_rows($query);
							?>
                                <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Class List</div>
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_class1.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query1 = mysqli_query($connection,"select * from class")or die(mysql_error());
